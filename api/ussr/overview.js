...
export default async function handler(req, res) {
  ...
  function buildSnapshot(bot) {
        ...
        // total rubles in circulation (all citizens cash+bank, even 0-balance members counted via 0)
        ...
        return {
          ...
          war: bot.war ? { vault: bot.war.vault||0, armory: bot.war.armory||{}, ranks: bot.war.ranks||{}, power: bot.war.power||{}, wars: (bot.war.wars||[]).slice(-10) } : null
        };
  }
